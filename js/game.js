// Liste des joueurs actuels avec indices basés sur numéro et équipe
document.addEventListener("DOMContentLoaded", () => {
    ...
    function afficherIndice() {
        ...
        // Mise à jour progression et message
    ...
    function passeAuJoueurSuivant() {
        ...
        // Mise à jour progression quand on passe au joueur suivant
        progressionDiv.textContent = `Player ${joueurIndex + 1} / ${joueurs.length} — Score : ${score}`;
    ...
    boutonSkip.addEventListener("click", () => {
        ...
        //setTimeout(passeAuJoueurSuivant, 3000);
    });

    boutonValider.addEventListener("click", () => {
        // Si on est en mode "Next", on passe simplement au joueur suivant
        ...
        if (reponse === bonneReponse) {
            ...
            if (essaisRestants === 0) {
                ...
                //setTimeout(passeAuJoueurSuivant, 2500);
                boutonValider.textContent = "Next";
                boutonValider.style.marginTop = "4px";
                enAttenteDeSuivant = true;
                boutonHint.style.display = "none";
